package com.dca.labviewer.app.gateway.security;
...
public class SpringSecurityConfig {
	...
	//Cambiar los enlaces y colocar los que correspondan a Labviewer
	//Estos son los mismos que deben estar ya en Zuul server
	@Bean
